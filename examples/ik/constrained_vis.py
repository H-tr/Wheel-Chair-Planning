...
Same target poses as trac_ik_vis.py but using the Pink constrained
backend — with wrist-camera stabilization.
...
def main():
    ...
    print("\n" + "=" * 80)
    print("SUMMARY (Pink, camera-constrained)")
    print("=" * 80)
    print(
