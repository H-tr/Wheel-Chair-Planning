...
from wheelchair_planning.envs import pybullet_interface as vpb
from wheelchair_planning.envs.base_env import BaseEnv
from wheelchair_planning.types import RobotConfig
...
class PyBulletEnv(BaseEnv):
    ...
    def set_configuration(self, config: np.ndarray):
        """Apply a full 10-DOF config (3 base + 7 arm) to the visualization."""
