...
def create_ik_solver(
    ...
    *,
    ...
    if backend == "trac_ik":
        try:
            from wheelchair_planning.kinematics.trac_ik_solver import TracIKSolver
    ...
    if backend == "pink":
        from wheelchair_planning.kinematics.collision_model import build_collision_model
